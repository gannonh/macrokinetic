...
struct DoseTitrationTests {
    ...
    func createTestModelContainer() throws -> ModelContainer {
        ...
        return try ModelContainer(for: DoseTitration.self, MedicationProfile.self, configurations: config)
    }
    ...
    func testMarkCompleted() throws {
        ...
        // Create titration
        let titration = createTestTitration(fromDose: 0.25, toDose: 0.5)
    ...
    @MainActor
    func testValidateTitrationValid() throws {
    ...
    @MainActor
    func testValidateTitrationSameDose() throws {
    ...
    @MainActor
    func testValidateTitrationLowerDose() throws {
        let futureDate = Date().addingTimeInterval(86400 * 7)
        let titration = createTestTitration(
            fromDose: 0.5,
    ...
    @MainActor
    func testValidateTitrationPastDate() throws {
    ...
    func testTitrationDescription() throws {
        let titration = createTestTitration(fromDose: 0.25, toDose: 1.0)
    ...
    @MainActor
    func testStatusTextScheduled() throws {
        let titration = createTestTitration(fromDose: 0.25, toDose: 0.5, isCompleted: false)
    ...
    func testStatusTextCompleted() throws {
        let titration = createTestTitration(fromDose: 0.25, toDose: 0.5, isCompleted: true)
    ...
    @MainActor
    func testIsFutureTrue() throws {
        let futureDate = Date().addingTimeInterval(86400 * 7) // 1 week from now
        let titration = createTestTitration(scheduledDate: futureDate, isCompleted: false)
    ...
    @MainActor
    func testIsFutureFalseForPast() throws {
        let pastDate = Date().addingTimeInterval(-86400) // 1 day ago
        let titration = createTestTitration(scheduledDate: pastDate, isCompleted: false)
    ...
    @MainActor
    func testIsFutureFalseForCompleted() throws {
        let futureDate = Date().addingTimeInterval(86400 * 7)
        let titration = createTestTitration(scheduledDate: futureDate, isCompleted: true)
    ...
    @MainActor
    func testIsOverdueFalseForFuture() throws {
        let futureDate = Date().addingTimeInterval(86400 * 7)
        let titration = createTestTitration(scheduledDate: futureDate, isCompleted: false)
    ...
    @MainActor
    func testIsOverdueFalseForCompleted() throws {
        let pastDate = Date().addingTimeInterval(-86400)
        let titration = createTestTitration(scheduledDate: pastDate, isCompleted: true)
    ...
    @MainActor
    func testMarkCompletedWithoutProfile() throws {
        let titration = createTestTitration()
