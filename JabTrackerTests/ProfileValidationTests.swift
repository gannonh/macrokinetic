...
struct ProfileValidationTests {
    ...
    func weightStringValidationValidRanges() throws {
        ...
        #expect(
            ProfileValidation.isValidWeight("70.5") == true, "Valid decimal weight should be accepted")
        #expect(
            ProfileValidation.isValidWeight("10") == true, "Minimum valid weight should be accepted")
        #expect(
            ProfileValidation.isValidWeight("500") == true, "Maximum valid weight should be accepted")
    ...
    func weightStringValidationInvalidInputs() throws {
        ...
        #expect(
            ProfileValidation.isValidWeight("9.9") == false, "Weight below minimum should be rejected")
        #expect(
            ProfileValidation.isValidWeight("500.1") == false, "Weight above maximum should be rejected")
        #expect(ProfileValidation.isValidWeight("") == false, "Empty string should be rejected")
        #expect(
            ProfileValidation.isValidWeight("abc") == false, "Non-numeric string should be rejected")
    ...
    func weightStringValidationEdgeCases() throws {
        // Test edge cases
        #expect(
            ProfileValidation.isValidWeight("10.0") == true,
            "Exact minimum with decimal should be accepted")
        #expect(
            ProfileValidation.isValidWeight("500.0") == true,
            "Exact maximum with decimal should be accepted")
        #expect(
            ProfileValidation.isValidWeight("50.123456") == true,
            "High precision decimal should be accepted")
        #expect(
            ProfileValidation.isValidWeight("  75  ") == false,
            "Weight with spaces should be rejected (no trimming)")
        #expect(
            ProfileValidation.isValidWeight("1e2") == true,
    ...
    func weightDoubleValidationValidRanges() throws {
        ...
        #expect(
            ProfileValidation.isValidWeight(70.5) == true, "Valid decimal weight should be accepted")
        #expect(
            ProfileValidation.isValidWeight(10.0) == true, "Minimum valid weight should be accepted")
        #expect(
            ProfileValidation.isValidWeight(500.0) == true, "Maximum valid weight should be accepted")
    ...
    func nameValidationValid() throws {
        ...
        for name in validNames {
            #expect(
                ProfileValidation.isValidName(name) == true,
    ...
    func nameValidationInvalid() throws {
        ...
        for name in invalidNames {
            #expect(
                ProfileValidation.isValidName(name) == false,
    ...
    func profileValidationRequirements() throws {
        ...
        #expect(
            ProfileValidation.isValidProfile(name: validName, weight: validWeight) == true,
            "Valid name and weight should result in valid profile")
        #expect(
            ProfileValidation.isValidProfile(name: validName, weight: invalidWeight) == false,
            "Invalid weight should result in invalid profile")
        #expect(
            ProfileValidation.isValidProfile(name: emptyName, weight: validWeight) == false,
            "Empty name should result in invalid profile")
        #expect(
            ProfileValidation.isValidProfile(name: emptyName, weight: invalidWeight) == false,
    ...
    func weightLimitsConstants() throws {
        ...
        #expect(
            ProfileValidation.WeightLimits.minimum < ProfileValidation.WeightLimits.maximum,
    ...
    func profileValidationEdgeCases() throws {
        ...
        let edgeCases = [
            ...
            WeightValidationTest(
                input: "10.", expected: true, description: "Number with trailing decimal"),
            WeightValidationTest(
                input: ".5", expected: false, description: "Decimal without leading zero"),
            WeightValidationTest(
                input: "12.34567890", expected: true, description: "High precision decimal"),
            WeightValidationTest(
                input: "100,5", expected: false, description: "Comma as decimal separator"),
