...
struct DoseHistoryViewModelFilterTests {
    ...
    func searchFiltersDoses() async throws {
        ...
        let dose2 = self.createTestDose(timestamp: Date().addingTimeInterval(3600), amount: 2.0, notes: "Evening dose")
    ...
    func filterByInjectionSite() async throws {
        ...
        let dose2 = self.createTestDose(timestamp: Date().addingTimeInterval(3600), amount: 2.0, site: "Arm")
        let dose3 = self.createTestDose(timestamp: Date().addingTimeInterval(7200), amount: 1.5, site: "Thigh")
    ...
    func combineMultipleFilters() async throws {
        ...
        let dose1 = self.createTestDose(timestamp: today, amount: 1.0, site: "Thigh", notes: "Morning dose")
        let dose2 = self.createTestDose(timestamp: today, amount: 2.0, site: "Arm", notes: "Evening dose")
        let dose3 = self.createTestDose(timestamp: yesterday, amount: 1.5, site: "Thigh", notes: "Yesterday dose")
    ...
    func clearAllFilters() async throws {
        ...
        let dose1 = self.createTestDose(timestamp: Date(), amount: 1.0, site: "Thigh", notes: "Morning dose")
