...
struct BiometricAuthManagerCoreTests {
    ...
    func biometricAuthenticationInterface() throws {
        ...
        Task {
            ...
            do {
                let result = try await biometricManager.authenticateWithBiometrics(reason: "Test authentication")
    ...
    func biometricAuthDisabledHandling() throws {
        ...
        Task {
            do {
                ...
                #expect(error == BiometricError.notAvailable || error == BiometricError.disabled,
