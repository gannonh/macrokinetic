...
struct BiometricEnumTests {
    ...
    func biometricErrorDescriptions() throws {
        ...
        #expect(authenticationFailed.localizedDescription.contains("failed"),
        ...
        for error in allErrors {
            #expect(!error.localizedDescription.isEmpty, "Error description should not be empty for \(error)")
            #expect(error.localizedDescription.count > 5, "Error description should be descriptive for \(error)")
        }
    }
