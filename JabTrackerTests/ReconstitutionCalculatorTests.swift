...
struct ReconstitutionCalculatorTests {
    ...
    func testStandardReconstitution() throws {
    ...
    func testReconstitutionWith10mgVial() throws {
    ...
    func testVerySmallDoses() throws {
    ...
    func testMaximumDoseEqualsVialStrength() throws {
