...
struct MedicationCoverageTests {
    ...
    func testAllMedicationPropertiesDirectly() throws {
        ...
        for medication in Medication.allCases {
            ...
            #expect(frequency == .daily || frequency == .weekly, "Frequency should be daily or weekly for \(medication)")
    ...
    func testSpecificMedicationValues() throws {
        // Semaglutide
    ...
    func testDoseFrequencyDisplayName() throws {
