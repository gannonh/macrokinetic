...
struct UserAnalyticsTests {
  ...
  func userAnalyticsPreferencesFields() throws {
    ...
    #expect(
      user.preferredReportingFrequency == "monthly",
      "Preferred reporting frequency should be monthly")
  }
  ...
  func userAnalyticsPreferencesDefaults() throws {
    ...
    #expect(
      user.analyticsReportingEnabled == true, "Analytics reporting should be enabled by default")
    #expect(
      user.preferredReportingFrequency == "weekly", "Default reporting frequency should be weekly")
  ...
  func userAnalyticsPreferencesCloudKitCompatibility() throws {
    ...
    #expect(
      user.analyticsEnabled == true || user.analyticsEnabled == false,
      "Analytics enabled should be a valid boolean for CloudKit")
    ...
    #expect(
      !user.preferredReportingFrequency.isEmpty,
      "Preferred reporting frequency should not be empty for CloudKit")
  }
  ...
  func userAdherenceCalculationNoDoses() throws {
    ...
    #expect(
      user.averageTimeBetweenDoses == 0.0, "Average time between doses should be 0.0 with no doses")
  }
  ...
  func userAdherenceCalculationPerfectAdherence() throws {
    ...
    #expect(
      user.currentAdherenceRate == 1.0, "Adherence rate should be 1.0 (100%) with perfect adherence"
    )
  ...
  func userAdherenceCalculationMissedDoses() throws {
    ...
    #expect(
      abs(user.currentAdherenceRate - expectedAdherence) < 0.01,
      "Adherence rate should be approximately 71% (5/7)")
  ...
  func userAdherenceCalculationSkippedDoses() throws {
    ...
    #expect(
      abs(user.currentAdherenceRate - expectedAdherence) < 0.01,
      "Skipped doses should not count toward adherence")
  }
  ...
  func userAdherenceRateCalculationPeriod() throws {
    ...
    #expect(
      abs(user.currentAdherenceRate - expectedAdherence) < 0.01,
      "Adherence should be calculated based on user's adherence goal period")
  }
  ...
  func userAverageTimeBetweenDosesCalculation() throws {
    ...
    #expect(
      abs(user.averageTimeBetweenDoses - expectedAverageSeconds) < 3600,
      "Average time between doses should be approximately 7 days")
  }
  ...
  func userAnalyticsIntegrationWithExistingFields() throws {
    ...
    #expect(
      user.displayEmail == "integration@example.com", "Existing display email should still work")
    #expect(
      user.emailForCloudKit == "integration@example.com",
      "Existing CloudKit email should still work")
    ...
    #expect(
      user.preferredReportingFrequency == "biweekly", "New reporting frequency field should work")
  }
  ...
  func userAnalyticsComputedPropertiesPerformance() throws {
    ...
    #expect(
      elapsedTime < 1.0, "Analytics computed properties should be performant with large datasets")
  }
