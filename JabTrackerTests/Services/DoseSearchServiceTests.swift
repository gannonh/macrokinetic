...
struct DoseSearchServiceTests {
    ...
    func testSearchWithEmptyInput() throws {
    ...
    func testSearchInMedication() throws {
        ...
        let tirzepatideProfile = createTestMedicationProfile(
    ...
    func testSearchInInjectionSite() throws {
        ...
        let upperArmDose = createTestDose(site: "Upper Arm")
    ...
    func testSearchInAmount() throws {
    ...
    func testSearchInDate() throws {
        ...
        let januaryDose = createTestDose(timestamp: january1)
        let decemberDose = createTestDose(timestamp: december31)
    ...
    func testSearchModeContains() throws {
    ...
    func testSearchModeExact() throws {
    ...
    func testSearchModeStartsWith() throws {
        // Given: Dose with specific content
        let dose = createTestDose(notes: "morning injection")
        let doses = [dose]
    ...
    func testSearchModeEndsWith() throws {
        // Given: Dose with specific content
        let dose = createTestDose(notes: "morning injection")
        let doses = [dose]
    ...
    func testCaseSensitivity() throws {
        ...
        #expect(caseSensitiveNoMatch.count == 0)
    }
    
    // MARK: - Multiple Term Search Tests
    
    @Test("Multiple terms search with AND logic")
    func testMultipleTermsANDLogic() throws {
    ...
    func testMultipleTermsORLogic() throws {
        // Given: Doses with various content
    ...
    func testParseAdvancedSearch() throws {
        ...
        // Amount filter
        if case .greaterThan(let amount) = searchQuery.amountFilter {
            #expect(amount == 1.0)
        } else {
    ...
    func testAmountFilterEquals() throws {
        // Given: Amount filter
    ...
    func testAmountFilterComparisons() throws {
    ...
    func testDateFilterParsing() throws {
    ...
    func testQueryTokenization() throws {
    ...
    func testEmptySearchTermHandling() throws {
    ...
    func testSearchPerformance() throws {
        ...
        #expect(results.count > 0) // Should find matching doses
        #expect(results.allSatisfy { dose in
            dose.notes?.contains("500") == true || String(dose.amount).contains("500")
        })
    }
    
    @Test("Search handles nil values gracefully")
    func testSearchWithNilValues() throws {
