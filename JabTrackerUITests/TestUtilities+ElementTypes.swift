...
extension TestUtilities {
    ...
    private static func inputControlElementTypeName(from elementType: XCUIElement.ElementType) -> String? {
        switch elementType {
    ...
    private static func navigationElementTypeName(from elementType: XCUIElement.ElementType) -> String? {
    ...
    private static func navigationBarElementTypeName(from elementType: XCUIElement.ElementType) -> String? {
        switch elementType {
