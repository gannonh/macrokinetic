...
final class JabTrackerUITestsLaunchTests: XCTestCase {
    ...
    func testAppLaunchAndTabNavigation() throws {
        ...
        XCTAssertTrue(app/*@START_MENU_TOKEN@*/ .staticTexts["Add medication profiles"]/*[[".otherElements.staticTexts[\"Add medication profiles\"]",".staticTexts[\"Add medication profiles\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/ .exists, "Add Dose title should exist")
        ...
        XCTAssertTrue(app/*@START_MENU_TOKEN@*/ .staticTexts["Quick Add Dose"]/*[[".navigationBars",".staticTexts.firstMatch",".staticTexts[\"Quick Add Dose\"]"],[[[-1,2],[-1,0,1]],[[-1,2],[-1,1]]],[0]]@END_MENU_TOKEN@*/ .exists, "Add Dose title should exist")
        ...
        XCTAssertTrue(app/*@START_MENU_TOKEN@*/ .staticTexts["No doses logged yet"]/*[[".otherElements.staticTexts[\"No doses logged yet\"]",".staticTexts[\"No doses logged yet\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/ .exists, "History title should exist")
        ...
        XCTAssertTrue(app/*@START_MENU_TOKEN@*/ .staticTexts["medication-management-header"]/*[[".otherElements",".staticTexts[\"Medication Management\"]",".staticTexts[\"medication-management-header\"]"],[[[-1,2],[-1,1],[-1,0,1]],[[-1,2],[-1,1]]],[0]]@END_MENU_TOKEN@*/ .exists, "Settings title should exist")
