...
**Acceptance Criteria:**
- [x] Long-press on Food Log shows "Clear Day" option in context menu
- [x] Selecting "Clear Day" shows confirmation dialog before deletion
- [x] Confirmation dialog shows count of entries to be deleted
- [x] All food entries for that day are deleted upon confirmation
- [x] Operation is cancellable via dialog dismiss
...
**Acceptance Criteria:**
- [x] Swipe-to-delete button uses red background color
- [x] Matches iOS system destructive action styling
...
**Acceptance Criteria:**
- [x] Food Log calendar shows Monday as first day of week
- [x] Week boundaries match Weekly Nutrition Hero (Mon-Sun)
- [x] Navigation between weeks works correctly with new start day
