...
class DoseSearchService {
        ...
        caseSensitive: Bool = false) -> [Dose]
    {
        ...
        return doses.filter { dose in
            self.matchesDose(dose, searchText: trimmedText, scope: scope, mode: mode, caseSensitive: caseSensitive)
        }
    }
        ...
        caseSensitive: Bool = false) -> [Dose]
    {
        ...
        return doses.filter { dose in
            searchTerms.allSatisfy { term in
                self.matchesDose(dose, searchText: term, scope: scope, mode: mode, caseSensitive: caseSensitive)
            }
        }
    }
    ...
    static func searchWithAdvancedQuery(doses: [Dose], query: SearchQuery) -> [Dose] {
        doses.filter { dose in
            ...
            for phrase in query.exactPhrases {
                guard self.matchesDose(dose, searchText: phrase, scope: .all, mode: .exact, caseSensitive: false) else {
                    return false
                }
            }
        ...
        caseSensitive: Bool) -> Bool
    {
        switch scope {
        case .all:
            return self.matchesInNotes(dose, searchText: searchText, mode: mode, caseSensitive: caseSensitive) ||
                self.matchesInMedication(dose, searchText: searchText, mode: mode, caseSensitive: caseSensitive) ||
                self.matchesInInjectionSite(dose, searchText: searchText, mode: mode, caseSensitive: caseSensitive) ||
                self.matchesInAmount(dose, searchText: searchText, mode: mode, caseSensitive: caseSensitive) ||
                self.matchesInDate(dose, searchText: searchText, mode: mode, caseSensitive: caseSensitive)

        case .notes:
            return self.matchesInNotes(dose, searchText: searchText, mode: mode, caseSensitive: caseSensitive)

        case .medication:
            return self.matchesInMedication(dose, searchText: searchText, mode: mode, caseSensitive: caseSensitive)

        case .injectionSite:
            return self.matchesInInjectionSite(dose, searchText: searchText, mode: mode, caseSensitive: caseSensitive)

        case .amount:
            return self.matchesInAmount(dose, searchText: searchText, mode: mode, caseSensitive: caseSensitive)

        case .date:
            return self.matchesInDate(dose, searchText: searchText, mode: mode, caseSensitive: caseSensitive)
        }
    }
        ...
        caseSensitive: Bool) -> Bool
    {
        ...
        return self.matchesString(notes, searchText: searchText, mode: mode, caseSensitive: caseSensitive)
    }
        ...
        caseSensitive: Bool) -> Bool
    {
        ...
        return self.matchesString(site, searchText: searchText, mode: mode, caseSensitive: caseSensitive)
    }
        ...
        caseSensitive: Bool) -> Bool
    {
        ...
        return self.matchesString(amountString, searchText: searchText, mode: mode, caseSensitive: caseSensitive)
    }
        ...
        caseSensitive: Bool) -> Bool
    {
        ...
        return self.matchesString(dateString, searchText: searchText, mode: mode, caseSensitive: caseSensitive)
    }
