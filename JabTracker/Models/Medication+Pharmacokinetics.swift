...
extension Medication {
    ...
    func concentrationAtTime(
        ...
        timeElapsedHours: Double) -> Double
    {
...
extension Medication {
    ...
    var hasValidPharmacokinetics: Bool {
        halfLifeDays > 0 &&
            ...
            self.subcutaneousBioavailability > 0 &&
            self.subcutaneousBioavailability <= 1.0 &&
            self.peakTimeHours > 0 &&
            self.peakTimeHours < 168 // No peak time should exceed 1 week
    }
