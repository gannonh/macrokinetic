...
/// Legacy onboarding step (v0.5.x and earlier). Retained for reference only.
/// New implementation: JabTracker/Onboarding/OnboardingStep.swift
enum LegacyOnboardingStep: String, CaseIterable {
    case welcome
