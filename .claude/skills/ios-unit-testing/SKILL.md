...
description: iOS/Swift Testing framework patterns. Use when writing Swift unit tests, debugging test failures, setting up SwiftData test data, or achieving coverage levels. Covers Swift Testing syntax, SwiftData test patterns, @MainActor requirements, and coverage policy.
---
