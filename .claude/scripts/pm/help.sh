...
echo "  3. /pm:epic-decompose <name> - Break into issues"
echo "  4. /pm:epic-sync <name>      - Push to GitHub"
echo "  5. /pm:issue-start <num>     - Start work on individual issues"
echo ""
echo "📄 PRD Commands"
...
echo ""
echo "📚 Epic Commands"
echo "  /pm:epic-decompose <name> - Break epic into issue files"
echo "  /pm:epic-sync <name>      - Push epic and issues to GitHub"
echo "  /pm:epic-oneshot <name>   - Decompose and sync in one command"
echo "  /pm:epic-list             - List all epics"
echo "  /pm:epic-show <name>      - Display epic and its issues"
...
echo "  /pm:epic-refresh <name>   - Update epic progress from issues"
echo ""
echo "📝 Issue Commands"
echo "  /pm:issue-show <num>      - Display issue and sub-issues"
echo "  /pm:issue-status <num>    - Check issue status"
echo "  /pm:issue-start <num>     - Create branch + PR + begin work"
echo "  /pm:issue-update <num>    - Update progress and capture session work"
echo "  /pm:issue-resume <num>    - Resume work on in-progress issues"
echo "  /pm:issue-sync <num>      - Push updates to GitHub"
echo "  /pm:issue-merge <num>     - Mark PR ready → review → merge"
echo "  /pm:issue-close <num>     - Close issue + update epic progress"
...
echo "  • Full workflow: prd-new → prd-parse → epic-decompose → epic-sync → issue-start"
echo "  • Each issue gets its own branch and PR (issue/branch/PR mapping)"
