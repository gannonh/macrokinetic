...
gh api repos/gannonh/jab-tracker-ios/issues/$1 > /tmp/issue-$1.json
...
gh api repos/gannonh/jab-tracker-ios/issues/$1 \
  -X PATCH \
...
View issue: https://github.com/gannonh/jab-tracker-ios/issues/$1
```
