...
- Pass control back to the .windsurf/workflows/apm-1-initiate-setup.md logic.
- **Context Recovery:** When generating the Bootstrap Prompt, you must use the **EXACT TEMPLATE** from .windsurf/workflows/apm-1-initiate-setup.md. If the template is degraded or missing from your context window, **READ .windsurf/workflows/apm-1-initiate-setup.md** to retrieve it before generating the final artifact.
