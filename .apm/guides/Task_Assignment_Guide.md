...
- **Format:** Use the exact template provided in your .windsurf/workflows/apm-3-initiate-implementation.md instructions.
...
[Manager fills this section with section §7 content guidance, including explicit command references for Debug/Research delegations (.windsurf/workflows/apm-8-delegate-debug.md or .windsurf/workflows/apm-7-delegate-research.md)]
```
...
- **Debug Delegation**: Reference .windsurf/workflows/apm-8-delegate-debug.md
- **Research Delegation**: Reference .windsurf/workflows/apm-7-delegate-research.md  
